...
public class ManageEmployees extends javax.swing.JFrame {
    ...
    public void setTestFields(String [] allFields)
    {
        testing=true;
        testFields = allFields;
...
// Logger.getLogger(ManageEmployees.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public boolean testAddEmployee()
    {
        ...
        if(testing == false)
        {
         ...
         op = JOptionPane.showConfirmDialog(null, fields, "Employee Details", JOptionPane.OK_CANCEL_OPTION);
         ...
         if (op == JOptionPane.OK_OPTION)
            ...
            if (uname.equals("") || pw.equals("") || nm.equals("") || des.equals("") || sal.equals(""))
            {
                JOptionPane.showMessageDialog(null, "Error: one or more fields empty!");
                return false;
            }
        }
        ...
        else
        {
            ...
            System.out.println("testing fields " + uname + pw + nm + des + sal);
        ...
        if (true)
        {
           ...
           model.addRow(new Object[]{uname, nm,sal,des});
           ...
           String query = "Insert into employees(username,password,name,designation,salary) values(?,?,?,?,?)";
            ...
            {
                System.out.println("Primary ket exception");
                testOutput = false;
                exc.printStackTrace();
            }
            catch (SQLException ex) {
